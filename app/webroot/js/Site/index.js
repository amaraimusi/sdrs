...
$(function() {
	...
	$('#site_tbl').show();// 高速表示のためテーブルは最後に表示する
...
function init(){
	...
	crudBase.crudBaseBulkAdd.init(
		[
			{'field':'site_name', 'inp_type':'textarea'}, 
			{'field':'note', 'inp_type':'textarea'}, 
		],
		{
			'ajax_url':'site/bulk_reg',
			'ta_placeholder':"現場名の一覧を貼り付けてください。\n(例)\n見本A現場\n見本C現場\n見本D現場\n見本E現場",
		}
	);
}
...
function calendarViewKShow(){
	// カレンダービューを生成 
	crudBase.calendarViewCreate('site_date');
}
